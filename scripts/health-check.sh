...
# ヘルスチェック結果（Bash 3.x互換のため個別変数を使用）
HEALTH_STATUS_overall="healthy"
HEALTH_STATUS_process="unknown"
HEALTH_STATUS_config="unknown"
HEALTH_STATUS_dependencies="unknown"
HEALTH_STATUS_github_api="unknown"
HEALTH_STATUS_disk_space="unknown"
HEALTH_STATUS_logs="unknown"
